<nav class="bg-white border-b border-slate-200 shadow-sm flex-shrink-0">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="flex items-center lg:hidden"> {{-- Hanya tampil di bawah lg --}}
                ...
                {{-- Anda bisa menambahkan judul halaman atau breadcrumbs di sini jika mau --}}
                {{-- Contoh:
            ...
            <div class="flex items-center sm:ms-6"> {{-- hidden sm:flex diubah jadi flex agar selalu ada --}}
